...
GetEventsOnDate (what is|whats) (happening|going on|coming up|the haps|occurring|scheduled|on the calendar|set for|cool|ahead|destined|the future)
GetFeeDetailsIntent How much does (it cost to go to|it cost to attend|tickets for cost|it cost for tickets)
GetFeeDetailsIntent How much do (tickets cost|seats cost)
GetFeeDetailsIntent How much (money|moneys|bucks|buckaroos|cash|dough|green|smackaroos|wolfbucks) do tickets cost
GetFeeDetailsIntent How much are (tickets|seats|tickets for|seats for|prices for)
GetFeeDetailsIntent (Whats|what is) (the price|the price of|it cost to|it cost to attend|the cost to go to|the cost to attend)
...
AllCategoryIntent (all|all of them|everything|give me all of them|every category|all the categories|I want them all|list them all|give me all)
